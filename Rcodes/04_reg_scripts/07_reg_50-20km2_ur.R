...
# Remove Obs that are not part of urban from original data set
sample_dhs <- reg_ur[unlist(reg_obs$obs_selection), ]
...
etable(
  ...
  fitstat = ~ . + ivfall + ivwaldall.p,
  tex = TRUE,
  file = file.path(table_dir, "nosch624_edu_ndislog_50km2_ur.tex"),
  replace = TRUE,
  extralines = list(
    "_^Number of DHS Clusters" =  ~ num_clust,
    "_^Number of DHS Clusters with Aid" =  ~ tt_clust,
...
etable(
  ...
  fitstat = ~ . + ivfall + ivwaldall.p,
  tex = TRUE,
  file = file.path(table_dir, "nosch624_hmlieg_ndislog_50km2_ur.tex"),
  replace = TRUE,
  extralines = list(
    "_^Number of DHS Clusters" =  ~ num_clust,
    "_^Number of DHS Clusters with Aid" =  ~ tt_clust,
...
etable(
  ...
  fitstat = ~ . + ivfall + ivwaldall.p,
  tex = TRUE,
  file = file.path(table_dir, "nosch624_intxhmlieg_ndislog_50km2_ur.tex"),
  replace = TRUE,
  extralines = list(
    "_^Number of DHS Clusters" =  ~ num_clust,
    "_^Number of DHS Clusters with Aid" =  ~ tt_clust,
