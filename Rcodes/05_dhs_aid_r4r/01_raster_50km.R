...
## Temperature -------------------------------------------------------------
tmp_raster <- "../DO/GRID_025/1_DATA_PROCESSING/4_CEDA/input/cru_ts4.06.1901.2021.tmp.dat.nc" |> 
...
tmp_full_df |> 
  readr::write_csv("./data-intermediate/tmp_full_df.csv.gz")
rm(tmp_full_df)


## Precipitation -----------------------------------------------------------
pre_raster <- "../DO/GRID_025/1_DATA_PROCESSING/4_CEDA/input/cru_ts4.06.1901.2021.pre.dat.nc" |> 
...
# export intermediate data set
pre_full_df |> 
  readr::write_csv("./data-intermediate/pre_full_df.csv.gz")
rm(pre_full_df)



## Drought -----------------------------------------------------------------
spei_raster <- "../DO/GRID_025/1_DATA_PROCESSING/5-DROUGHT/input/spei12.nc" |> 
...
# export intermediate data set
spei_full_df |> 
  readr::write_csv("./data-intermediate/spei_full_df.csv.gz")
rm(spei_full_df)
...
# export intermediate data set
light_full_df |> 
  readr::write_csv("./data-intermediate/light_full_df.csv.gz")
rm(light_full_df)



## Conflict Data -----------------------------------------------------------
conflicts <- "../DO/GRID_025/1_DATA_PROCESSING/11_CONFLICTS/output/ged_loca.shp" |> 
  sf::st_read() 
...
# export intermediate data set
conflicts_df |> 
  readr::write_csv("./data-intermediate/conflicts_df.csv.gz")
...
pop_raster1 <-
  list.files(
    "../DO/GRID_025/1_DATA_PROCESSING/9_POPULATION/input",
    pattern = "\\.tif$",
    ignore.case = T,
    all.files = T,
    full.names = T,
...
# export intermediate data set
pop_full_df |> 
  readr::write_csv("./data-intermediate/pop_full_df.csv.gz")
rm(pop_full_df)
...
gadm <- read_csv("../DO/GRID_025/1_DATA_PROCESSING/12_GADM/output/gadm_regions_1_2.csv") 

# load intermediate data files
conflicts_df <- read_csv("./data-intermediate/conflicts_df.csv.gz")
tmp_full_df <- read_csv("./data-intermediate/tmp_full_df.csv.gz")
pre_full_df <- read_csv("./data-intermediate/pre_full_df.csv.gz")
spei_full_df <- read_csv("./data-intermediate/spei_full_df.csv.gz")
light_full_df <- read_csv("./data-intermediate/light_full_df.csv.gz")
pop_full_df <- read_csv("./data-intermediate/pop_full_df.csv.gz")
...
full_raster <- full_raster |>
  readr::write_csv("./data-r4r/data_raster_50km.csv.gz")
beepr::beep(3)
