...
# save countries in sample 

country_sample <- sample_dhs |>
  dplyr::select(DHSCC) |>
  dplyr::distinct()|>
  dplyr::mutate(
    dhscc2 = case_when(
...
write_csv(country_sample,"./data-r4r/country_sample.csv")
...
etable(
  ...
  tex = TRUE,
  file = file.path(table_dir, "nosch624_edu_50km2.tex"),
  replace = TRUE,
  extralines = list(
...
etable(
  ...
  fitstat = ~ . + ivfall + ivwaldall.p,
  tex = TRUE,
  file = file.path(table_dir, "nosch624_hmlieg_50km2.tex"),
  replace = TRUE,
  extralines = list(
    "_^Number of DHS Clusters" =  ~ num_clust,
    "_^Number of DHS Clusters with Aid" =  ~ tt_clust,
...
etable(
  ...
  fitstat = ~ . + ivfall + ivwaldall.p,
  tex = TRUE,
  file = file.path(table_dir, "nosch624_intxhmlieg_50km2.tex"),
  replace = TRUE,
  extralines = list(
    "_^Number of DHS Clusters" =  ~ num_clust,
    "_^Number of DHS Clusters with Aid" =  ~ tt_clust,
...
etable(
  ...
  fitstat = ~ . + ivfall + ivwaldall.p,
  tex = TRUE,
  file = file.path(table_dir, "nosch624_dedu_50km2.tex"),
  replace = TRUE,
  extralines = list(
    "_^Number of DHS Clusters" =  ~ num_clust,
    "_^Number of DHS Clusters with Aid" =  ~ tt_clust,
...
etable(
  ...
  fitstat = ~ . + ivfall + ivwaldall.p,
  tex = TRUE,
  file = file.path(table_dir, "nosch624_dhmlieg_50km2.tex"),
  replace = TRUE,
  extralines = list(
    "_^Number of DHS Clusters" =  ~ num_clust,
    "_^Number of DHS Clusters with Aid" =  ~ tt_clust,
...
etable(
  ...
  fitstat = ~ . + ivfall + ivwaldall.p,
  tex = TRUE,
  file = file.path(table_dir, "nosch624_dintxhmlieg_50km2.tex"),
  replace = TRUE,
  extralines = list(
    "_^Number of DHS Clusters" =  ~ num_clust,
    "_^Number of DHS Clusters with Aid" =  ~ tt_clust,
