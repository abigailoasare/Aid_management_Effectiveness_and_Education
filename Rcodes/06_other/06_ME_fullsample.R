...
ct <- summary(reg_ind3, cluster = ~ DHSID)$coeftable
...
print(me_ind_table, file = file.path(table_dir, "ME_ind-R2.tex"))
...
# Save the LaTeX table to the file
print(me_counts_table, file = file.path(table_dir, "ME_counts-R2.tex"))
...
# Save the LaTeX table to the file
print(me_disb_table , file = file.path(table_dir, "ME_disb-R2.tex"))
